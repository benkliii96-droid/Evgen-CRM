      ...
      <header className="bg-white dark:bg-[#25213b] shadow-sm border-b border-[#e8e4ff] dark:border-[#3d3860]">
        <div className="max-w-5xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              {darkMode ? (
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 text-[#6e6893]">
          ...
          <div className="h-64 md:h-96 bg-[#f8f7ff] dark:bg-[#2d2847] flex items-center justify-center">
            {product.image ? (
              ...
              <div className="text-center">
                <svg width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-24 h-24 opacity-50 mx-auto mb-4 text-[#6e6893]">
